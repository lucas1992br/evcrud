...
var require_default_theme = __commonJS({
  "node_modules/tailwindcss/dist/default-theme.js"(exports, module) {
    "use strict";
    var C = ["anchor-size"];
    var N = new RegExp(`(${C.join("|")})\\(`, "g");
    var m = new Uint8Array(256);
    function k(e, c) {
      let t = 0, g = [], u = 0, d = e.length, E = c.charCodeAt(0);
      for (let n = 0; n < d; n++) {
