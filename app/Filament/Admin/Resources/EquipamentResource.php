...
use App\Filament\Admin\Resources\EquipamentResource\Pages;
use App\Filament\Admin\Resources\EquipamentResource\RelationManagers;
...
class EquipamentResource extends Resource
{
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => Pages\ViewEquipament::route('/{record}'),
